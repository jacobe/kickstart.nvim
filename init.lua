...
-- Automatically saves when switching buffers with specific commands like :buffer, CTRL-^ (buffer toggle), :next, :previous, etc.
...
-- Window navigation
--
-- TIP: Use CTRL+<hjkl> to switch between windows
...
require('lazy').setup({
  ...
  'mg979/vim-visual-multi', -- Multiple cursors for Neovim
